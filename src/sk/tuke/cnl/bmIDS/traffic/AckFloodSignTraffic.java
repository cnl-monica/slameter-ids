...
// *
// *  Zdrojove texty:
// *  Subor: AckFloodSignTraffic.java
// */
...
//
///**
// * Prevádzka roztriedená podľa charakteristík útoku typu ACK Flood. 
// * @author Ladislav Berta
// */
//public class AckFloodSignTraffic {
//
//    private long id;
...
//
//    /**
//     * Vytvorí objekt prevádzky podľa charakteristík útoku typu ACK Flood.
//     * @param obsPoint
//     * @param sourceIP
//     * @param destIP
//     * @param destPort
...
//     * @param till 
//     */
//    public AckFloodSignTraffic(int obsPoint, String sourceIP, String destIP, int destPort, int ackCount, long since, long till) {
...
//     * @return počet ACK príznakov v zatriedenej prevádzke 
//     */
//    public int edit(IPFlow currentIPFlow) {
//        boolean newSrcIP = true;
//
//        ackCount += currentIPFlow.getAckCount();
//
//        if (firstEdit) {
...
//    }
//
//    public void update(AckFloodSignTraffic maxTraffic, double probability) {
//        if (tillMilis < maxTraffic.getTillMilis()) {
//            tillMilis = maxTraffic.getTillMilis();
//        }
//        ackCount += maxTraffic.getAckCount();
...
//                return false;
//            }
//        } else if (obj instanceof AckFloodSignTraffic) {
//            AckFloodSignTraffic traffic = (AckFloodSignTraffic) obj;
