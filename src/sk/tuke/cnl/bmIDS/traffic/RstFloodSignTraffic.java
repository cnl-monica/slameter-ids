 ...
 *
 *  Zdrojove texty:
 *  Subor: RstFloodSignTraffic.java
 */
...
/**
 * Prevádzka roztriedená podľa charakteristík útoku typu RST Flood. 
 * @author Ladislav Berta
 */
public class RstFloodSignTraffic {
    ...
    /**
     * Vytvorí objekt prevádzky podľa charakteristík útoku typu RST Flood.
     * @param obsPoint
     * @param sourceIP
     * @param destIP
     * @param destPort
     ...
     * @param tillMilis 
     */
    public RstFloodSignTraffic(int obsPoint, String sourceIP, String destIP, int destPort, int rstCount, long since, long till) {
     ...
     * @return počet RST príznakov v zatriedenej prevádzke 
     */
    public int edit(IPFlow currentIPFlow) {
        rstCount += currentIPFlow.getRstCount();
    ...
    public void update(RstFloodSignTraffic maxTraffic, double probability) {
        if (tillMilis < maxTraffic.getTillMilis()) {
            tillMilis = maxTraffic.getTillMilis();
        }
        rstCount += maxTraffic.getRstCount();
    ...
    public boolean equals(Object obj) {
        ...
        } else if (obj instanceof RstFloodSignTraffic) {
            RstFloodSignTraffic traffic = (RstFloodSignTraffic) obj;
